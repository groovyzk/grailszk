...
class OldScaffoldingTemplate implements ScaffoldingTemplate {
    ...
    void initComponents(Class<?> scaffold,
                               Component window,
...
//        Collections.sort(scaffoldProps, new DomainClassPropertyComparator(dc)) // TODO: verify
