...
class ZulResponse {
    ...
    private static Logger LOG = LoggerFactory.getLogger(ZulResponse)
    ...
    ZulResponse(String urlStr, HttpServletRequest request, HttpServletResponse response, ServletContext servletContext) {
...
class ResponseBuffer extends HttpServletResponseWrapper {
    ...
    ResponseBuffer(HttpServletResponse response) {
        super(response)
    }
}
